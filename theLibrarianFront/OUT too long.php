...
<!------------------------------------------MAIN MENU------------------------------------------->
<div class="mainMenu">
	        <a class="current" href = "newHomePage.html #TheTitle">HOME</a>
	        <a href = 'newAbout.html'>ABOUT</a>
	        <a href = 'newPlans.html'>PLANS</a>
	        <a href = 'newSearch.html'>SEARCH</a>
	        <div class="locRight">
		...
		<div id="login" class="login" style="display: block;">
			<form class="login-form animate" method="POST" action="login.php">
				<div class="login-form-data" style="background-color:#f1f1f1">
					<h1>LIBRARY IN-CHARGE LOGIN</h1>
					<p class="invalidLogin">" RESTRICTED ACCESS "</p>
					<p class="invalidLogin">" YOU HAVE BEEN OUT TOO LONG "</p>
				</div>
				<div class="login-form-data">
					<label><b>UserID : </b><input type="text" name="Id" required autofocus placeholder="Enter email-id"></label>
					<br><br>
			...
			<div class="side">
				...
				<?php
					...
					if (filesize("../theMiscData/newArrival.txt")!=0) {
						...
						<div class='imagesOnPage' style='height:510px; background-image: url($img );'></div>
						<p>$desc </p>";
					}
				?>
			</div>
